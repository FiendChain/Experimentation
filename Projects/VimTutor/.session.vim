...
nnoremap <silent> gî :call multiple_cursors#select_all("n", 0)
xnoremap <silent> gî :call multiple_cursors#select_all("v", 0)
...
set hlsearch
set laststatus=2
set runtimepath=~/vimfiles,~\\vimfiles\\plugged\\vim-gitgutter,~\\vimfiles\\plugged\\editorconfig-vim,~\\vimfiles\\plugged\\vim-airline,~\\vimfiles\\plugged\\vim-airline-themes,~\\.fzf,~\\vimfiles\\plugged\\fzf.vim,~\\vimfiles\\plugged\\emmet-vim,~\\vimfiles\\plugged\\nerdtree,~\\vimfiles\\plugged\\vim-multiple-cursors,~\\vimfiles\\plugged\\vim-eunuch,~\\vimfiles\\plugged\\vim-surround,~\\vimfiles\\plugged\\ale,~\\vimfiles\\plugged\\vim-monokai,C:\\Program\ Files\ (x86)\\Vim/vimfiles,C:\\Program\ Files\ (x86)\\Vim\\vim81,C:\\Program\ Files\ (x86)\\Vim/vimfiles/after,~/vimfiles/after
set shiftwidth=4
set showtabline=2
...
silent! normal! zE
let s:l = 968 - ((57 * winheight(0) + 29) / 58)
...
wincmd w
argglobal
if bufexists('C:\Program\ Files\ (x86)\Vim\vim81\doc\help.txt') | buffer C:\Program\ Files\ (x86)\Vim\vim81\doc\help.txt | else | edit C:\Program\ Files\ (x86)\Vim\vim81\doc\help.txt | endif
let s:cpo_save=&cpo
set cpo&vim
imap <buffer> <S-BS> <Plug>delimitMateS-BS
imap <buffer> <BS> <Plug>delimitMateBS
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 69 - ((0 * winheight(0) + 14) / 29)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
69
...
wincmd w
argglobal
if bufexists('excerpt.txt') | buffer excerpt.txt | else | edit excerpt.txt | endif
let s:cpo_save=&cpo
set cpo&vim
imap <buffer> <S-BS> <Plug>delimitMateS-BS
imap <buffer> <BS> <Plug>delimitMateBS
...
wincmd w
argglobal
if bufexists('tutor.txt') | buffer tutor.txt | else | edit tutor.txt | endif
let s:cpo_save=&cpo
set cpo&vim
imap <buffer> <S-BS> <Plug>delimitMateS-BS
imap <buffer> <BS> <Plug>delimitMateBS
