...
class AdvancedColour(tuple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.updateRgbCache()       # get rgba tuple cache
    ...
    def __default__(self):
        ...
        self.range = collections.namedtuple("Range", ["min", "max"])(min=0, max=255)
        self.defaultValues = (0, 0, 0, 255)
        self.stringType = str
        # avoid setting using __setattr__, to avoid uninitialisation of self.components
        for component, value in zip(self.components, self.defaultValues):
    ...
    """
        Interface for accessing the tuple for pygame
    """
    def __getitem__(self, key):
        return self.rgbCache[key]
    
    def __getslice__(self, start, end):
        return self.rgbCache[start:end]

    def __setitem__(self, key, value):
        self.rgbCache[key] = value
    ...
    def set(self, *args, **kwargs):
        if len(args) == 1 and isinstance(args[0], self.stringType):
    ...
    def setDict(self, dictCode):
        for component, value in dictCode.items():
    ...
    def setRGB(self, rgbCode):
        for value, component in zip(rgbCode, self.components):
            setattr(self, component, self.clamp(value))
    ...
    def updateRgbCache(self):
        self.rgbCache = self.getRGB()
...
class RainbowColour(AdvancedColour):
    ...
    """
    def update(self, dt=1, tickrate=1, **kwargs):
        self.cycle(dt*tickrate)
...
"""
colour = {
    "transparent":  AdvancedColour(0, 0, 0, 0),
    "blue":         AdvancedColour("#333cff"),
    "green":        AdvancedColour("#009933"),
    "grey":         AdvancedColour("#b6b3b3"),
    "orange":       AdvancedColour("#ff5733"),
    "purple":       AdvancedColour("#5e33ff"),
    "red":          AdvancedColour("#ff0603"),
    "yellow":       AdvancedColour("#e6ac00"),
