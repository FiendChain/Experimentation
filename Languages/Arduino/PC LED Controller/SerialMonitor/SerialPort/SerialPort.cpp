...
SerialPort::SerialPort(const char *portName, unsigned baudRate, bool reset) 
{
    ...
    if (this->handler == INVALID_HANDLE_VALUE) {
        ...
        if (!GetCommState(this->handler, &dcbSerialParameters)) {
            ...
            dcbSerialParameters.fDtrControl = reset ? DTR_CONTROL_ENABLE : DTR_CONTROL_DISABLE;
...
int SerialPort::readSerialPort(void *buffer, unsigned int buf_size)
{
    DWORD bytesRead;
    unsigned int toRead;
